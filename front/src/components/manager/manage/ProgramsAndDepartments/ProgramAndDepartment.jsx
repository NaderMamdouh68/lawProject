...
const ProgramAndDepartment = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://graduate-programs.helwan.edu.eg/law/manager/allprogram', { withCredentials: true })
      .then((res) => {
        setProgram(res.data)
      }
      ).catch((error) => {
  ...
  const addDepartment = () => {
    if (document.querySelector('.add-department input').value !== '') {
      ...
      if (con) {
        axios.post('http://graduate-programs.helwan.edu.eg/law/manager/adddepartment', adddDepartment, { withCredentials: true })
          .then((res) => {
  ...
  const addpro = () => {
    ...
    axios.post('http://graduate-programs.helwan.edu.eg/law/manager/addprogram', addProgram, { withCredentials: true })
      .then((res) => {
